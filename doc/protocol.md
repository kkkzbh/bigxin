...
- 群聊：
  ...
  - `GROUP_SEARCH_REQ` / `GROUP_SEARCH_RESP`
  - `GROUP_JOIN_REQ` / `GROUP_JOIN_RESP`
  - `GROUP_JOIN_REQ_LIST_REQ` / `GROUP_JOIN_REQ_LIST_RESP`
  - `GROUP_JOIN_ACCEPT_REQ` / `GROUP_JOIN_ACCEPT_RESP`
- 心跳保活：
  - `PING` (C ↔ S)
  - `PONG` (C ↔ S)
